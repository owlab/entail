...
public class CTabItemWrapper {
    private static final  Logger _logger = LogUtil.getLogger(CTabItemWrapper.class.getName());
	...
	this.tabItemBody = new Text(this.composite, SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL | SWT.READ_ONLY | SWT.BORDER);
	GridData gridData4TabItemBody = new GridData(SWT.FILL, SWT.FILL, true, true);
	this.tabItemBody.setLayoutData(gridData4TabItemBody);

	this.tabItemMessage = new Text(this.composite, SWT.SINGLE | SWT.V_SCROLL | SWT.H_SCROLL | SWT.READ_ONLY | SWT.BORDER | SWT.WRAP);
...
//	this.setSelection();
	...
	this.cTabFolder.getDisplay().asyncExec(new AppendTextThread(/*this, */textList));
    }
	...
	//this.tabItemMessage.setText(message);
	this.cTabFolder.getDisplay().asyncExec(new SetMessageThread(/*this, */message));
    }
...
//    }
	...
	AppendTextThread(/*CTabItemWrapper cTabItemWrapper, */List<String> textList) {
	...
	String message;
	SetMessageThread(/*CTabItemWrapper tailClientController, */String message) {
